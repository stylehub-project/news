...
const ThinkingIndicator: React.FC = () => {
    ...
    return (
        <div className="flex flex-col gap-2 max-w-[85%] animate-in fade-in slide-in-from-bottom-2 duration-500 my-4">
            {/* Main Status Bubble */}
            <div className="flex items-center gap-3 p-3 bg-white border border-indigo-100 rounded-2xl rounded-tl-none shadow-sm w-fit transition-all duration-300">
                <div className="relative shrink-0">
                    <div className="absolute inset-0 bg-indigo-500 rounded-full blur animate-pulse opacity-40"></div>
                    <div className="relative bg-indigo-50 p-2 rounded-full text-indigo-600 border border-indigo-100">
            ...
            {/* Micro Fact / Context */}
            <div className="ml-1 flex items-center gap-2 text-[10px] text-gray-400 font-medium pl-1">
