...
const Sheet: React.FC<SheetProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      {/* Content */}
      <div 
        className={`relative w-full max-w-md bg-white rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] flex flex-col max-h-[85vh] transition-transform duration-300 ease-out transform ${animate ? 'translate-y-0' : 'translate-y-full'}`}
      >
        {/* Drag Handle */}
