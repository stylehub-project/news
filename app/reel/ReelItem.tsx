...
import ReelContextStrip from '../../components/reel/ReelContextStrip';
import ReelActionToolbar from '../../components/reel/ReelActionToolbar';
import ReelReaderCanvas from '../../components/reel/ReelReaderCanvas';
import SpokenBriefPlayer from '../../components/reel/SpokenBriefPlayer';
import AIInsightPanel from '../../components/reel/AIInsightPanel';
    ...
    <div className="relative h-full w-full bg-black overflow-hidden flex flex-col select-none">
      ...
      {showToast && (
          <div className="absolute top-20 left-1/2 -translate-x-1/2 z-50">
              <Toast type="success" message={isSaved ? "Saved to Library" : "Removed from Saved"} onClose={() => setShowToast(false)} />
          </div>
      )}
